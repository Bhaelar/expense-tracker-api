...
import com.example.expensetrackerapi.services.CategoryService;
...
public class CategoryResource {
	...
	@PostMapping("")
	public ResponseEntity<Integer> addCategory(HttpServletRequest request, @RequestBody Map<String, Object> categoryMap) {
		int userId = (Integer) request.getAttribute("userId");
		String title = (String) categoryMap.get("title");
		String description = (String) categoryMap.get("description");
		Integer category = categoryService.addCategory(userId, title, description);
